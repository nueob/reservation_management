            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">예약 </span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="/reservation_management/index" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> 예약 관리 </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="/reservation_charts/index" class="sidebar-link"
                      ><i class="mdi mdi-note-plus"></i
                      ><span class="hide-menu"> 예약 현황 </span></a
                    >
                  </li>
                </ul>
              </li>
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="/inquiry_board/index"
                  aria-expanded="false"
                  ><i class="mdi mdi-pencil"></i
                  ><span class="hide-menu">문의</span></a
                >
              </li>
            </ul>
          </nav>
